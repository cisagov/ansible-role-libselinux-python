...
issue](https://github.com/cisagov/ansible-role-libselinux-python/issues) in
...
request](https://github.com/cisagov/ansible-role-libselinux-python/pulls), you
...
```console
cd ansible-role-libselinux-python
pyenv virtualenv <python_version_to_use> ansible-role-libselinux-python
pyenv local ansible-role-libselinux-python
